...
class Robot:
    ...
    def update(self, dt):
       ...
       # print("Direction:" + str(self.direction))  # rechtsherum positiver, linksherum negativer
      #  print("angular: " + str(self.angularVelocity))

        test_direction = math.cos(self.direction)   #, math.sin(- self.direction)
        #print(test_direction)
        test_direction_2 = math.sin(- self.direction)
        print(test_direction_2)
