...
def check_args(args):
    ...
    assert args.sync_experience <= 25000 and args.sync_experience <= args.update_experience, "Sync experience must be less than or equal to 25000 and at least equal to update experience"
